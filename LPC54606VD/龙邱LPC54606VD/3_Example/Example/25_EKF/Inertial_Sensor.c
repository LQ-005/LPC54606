...
//    /* 平均 低通滤波 */
//    acc_vector.x = low_pass_filter2p.apply(&low_filter_acc_x, 0.4 * acc_vector_last[num].x + 0.2*(acc_vector_last[0].x + acc_vector_last[1].x + acc_vector_last[2].x));
//    acc_vector.y = low_pass_filter2p.apply(&low_filter_acc_y, 0.4 * acc_vector_last[num].y + 0.2*(acc_vector_last[0].y + acc_vector_last[1].y + acc_vector_last[2].y));
//    acc_vector.z = low_pass_filter2p.apply(&low_filter_acc_z, 0.4 * acc_vector_last[num].z + 0.2*(acc_vector_last[0].z + acc_vector_last[1].z + acc_vector_last[2].z));
//    
//    gyro_vector.x = low_pass_filter2p.apply(&low_filter_gyro_x, 0.4 * gyro_vector_last[num].x + 0.2*(gyro_vector_last[0].x + gyro_vector_last[1].x + gyro_vector_last[2].x));
//    gyro_vector.y = low_pass_filter2p.apply(&low_filter_gyro_y, 0.4 * gyro_vector_last[num].y + 0.2*(gyro_vector_last[0].y + gyro_vector_last[1].y + gyro_vector_last[2].y));
//    gyro_vector.z = low_pass_filter2p.apply(&low_filter_gyro_z, 0.4 * gyro_vector_last[num].z + 0.2*(gyro_vector_last[0].z + gyro_vector_last[1].z + gyro_vector_last[2].z));
//        
//    
//    //加速度AD值 转换成 米/平方秒 
...
//	gyro_vector.z *=  Gyro_Gr;
	...
	/* 储存原始数据 */
    gyro_vector.x = gyro_vector_last[num].x * Gyro_Gr;
	gyro_vector.y = gyro_vector_last[num].y * Gyro_Gr;
	gyro_vector.z = gyro_vector_last[num].z * Gyro_Gr;
	acc_vector.x = acc_vector_last[num].x * Acc_Gain * G;
	acc_vector.y = acc_vector_last[num].y * Acc_Gain * G;
	acc_vector.z = acc_vector_last[num].z * Acc_Gain * G;
