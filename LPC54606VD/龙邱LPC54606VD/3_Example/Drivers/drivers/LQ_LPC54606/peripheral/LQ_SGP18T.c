...
#define TFTSPI_CS     PT1_7     /*!< CS管脚 */ 
#define TFTSPI_SCL    PT1_20    /*!< SCL管脚 */ 
#define TFTSPI_SDA    PT1_19    /*!< SDI管脚 */ 
#define TFTSPI_DC     PT1_6     /*!< DC管脚 */ 
#define TFTSPI_RST    PT1_18    /*!< RST管脚 */ 
...
{ 	
  //-----端口初始化----//
	PIN_InitConfig(P1_7, PIN_MODE_OUTPUT, 0);
	PIN_InitConfig(P1_6, PIN_MODE_OUTPUT, 0);
	PIN_InitConfig(P1_19, PIN_MODE_OUTPUT, 0);
	PIN_InitConfig(P1_20, PIN_MODE_OUTPUT, 0);
...
{
    /* 设置显示范围 */
    TFTSPI_Set_Pos(wide_start, high_start, wide_start - 1 + wide, high_start + high);  
    uint16_t color;
