...
#define LCD_DI	PT1_20    /*!< OLED DI管脚 */ 
#define LCD_CK	PT1_7     /*!< OLED CK管脚 */ 
...
const uint8_t longqiu104x64[832] = {
...
{ 	 
    ...
    uint16_t wide_start = (128 - wide)/2;
    for(i=0;i<high-7;i+=8)
    {
        
        LCD_Set_Pos(wide_start,i/8+1);
