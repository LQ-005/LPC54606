...
extern char gImage_lo[17280];
extern char gImage_Battery_S[400];
extern char gImage_title2[5152];
...
/*!
  ...
  * @date     2019/6/13 星期四
  */
void TFTSPI_Show_Pic(uint8_t xs,uint8_t ys,uint8_t xe,uint8_t ye,char *ppic);
...
/*!
  ...
  * @date     2019/6/13 星期四
  */	
void TFTSPI_Show_Pic2(uint8_t xs,uint8_t ys,uint8_t w,uint8_t h,char *ppic) ;
...
/*!
  ...
  * @date     2019/12/3 星期二
  */
void TFTSPI_Road(uint16_t high_start, uint16_t wide_start, uint16_t high, uint16_t wide, uint8_t *Pixle);
...
/*!
  ...
  * @date     2019/12/3 星期二
  */
void TFTSPI_BinRoad(uint16_t high_start, uint16_t wide_start, uint16_t high, uint16_t wide, uint8_t *Pixle);
